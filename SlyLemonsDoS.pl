...
print <<EOTEXT;
Welcome to Slowloris - the low bandwidth, yet greedy and poisonous HTTP client developed by SlyLemons
EOTEXT
...
SlyLemons karkinopoustas@gmail.com
